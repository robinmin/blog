(() => {
    ...
    <div class="pagefind-modular-list-inner">
		...
		y = (i, e) => {
			const t = new r("li").class("pagefind-modular-list-result");
			if (e) {
				const l = new r("div").class("pagefind-modular-list-thumb").addTo(t);
				i?.meta?.image &&
					new r("img")
			...
			const s = new r("div").class("pagefind-modular-list-inner").addTo(t),
		...
		d = class {
			...
			async load() {
				...
				const e = this.resultFn(this.result, this.showImages),
					t = g(e);
